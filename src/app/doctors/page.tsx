    ...
    <div>
      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-16 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-blue-200 text-sm tracking-widest uppercase mb-2">Medical Team</p>
          <h1 className="text-3xl md:text-4xl font-bold">의료진 소개</h1>
          <p className="mt-3 text-blue-100">척추 전문 의료진이 최선을 다해 진료합니다.</p>
        </div>
      </section>
            ...
            {doctors.map((doc, idx) => (
              ...
              >
                ...
                <div className="shrink-0 flex flex-col items-center">
                  ...
                  <p className="mt-2 text-xs text-gray-400">사진 추후 업로드</p>
                </div>
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500 mb-4">전문분야: {doc.specialty}</p>

                  <h3 className="text-sm font-semibold text-gray-700 mb-2">학력 및 경력</h3>
      ...
      <section className="bg-blue-50 py-12 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-xl font-bold text-blue-900 mb-2">진료 예약 및 문의</h2>
